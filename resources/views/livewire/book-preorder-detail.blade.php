        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-6">
                ...
                <div class="inline-block bg-[#F2D837] px-8 py-3 rounded-full">
                    @if($book->isSoonToBeReleased())
                        <p class="text-lg md:text-xl font-bold text-brown-900 uppercase tracking-wide">Förbeställ nu!</p>
                    @else
                        <p class="text-lg md:text-xl font-bold text-brown-900 uppercase tracking-wide">Beställ med jul-inpackning!</p>
                    @endif
                </div>
            </div>
            ...
            <div class="mt-8 text-center">
                ...
                @if($book->isSoonToBeReleased())
                    <p class="text-lg text-brown-700">Få boken hemskickad så fort den är tillgänglig</p>
                @else
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                @if($book->publication_date)
                                    <div class="mb-3">
                                        <span class="text-sm font-semibold text-brown-700 uppercase tracking-wide">Beräknat utgivningsdatum</span>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start bg-white p-4 rounded-2xl shadow-sm">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-lg font-bold text-brown-900">Ingår!</div>
                                    <div class="text-sm text-gray-600">Be om en personlig hälsning från författaren</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="lg:sticky lg:top-8 h-fit">
                    <div class="bg-white p-8 rounded-3xl shadow-xl border-2 border-gray-200">
                        <div class="text-center mb-6">
                            <h3 class="text-3xl font-display font-bold text-brown-900 mb-2">Förbeställ nu</h3>
                            <p class="text-gray-600">Säkra ditt exemplar redan idag</p>
                        </div>
                    ...
                    <div class="mt-6 bg-gradient-to-br from-yellow-50 to-amber-50 p-6 rounded-2xl border-2 border-[#F2D837]">
                        ...
                        <ol class="space-y-2 text-sm text-brown-800">
                            <li class="flex items-start">
                                ...
                                <span>Fyll i formuläret och välj dina alternativ</span>
                            </li>
                            <li class="flex items-start">
                                <span class="font-bold mr-2 text-[#dac430]">2.</span>
                                <span>Du får en bekräftelse via e-post med Swish-betalningsinstruktioner</span>
                            </li>
                            <li class="flex items-start">
                                <span class="font-bold mr-2 text-[#dac430]">3.</span>
                                <span>Betala inom 2 timmar för att säkra din förbeställning</span>
                            </li>
                            <li class="flex items-start">
                                <span class="font-bold mr-2 text-[#dac430]">4.</span>
                                <span>Boken skickas hem till dig så snart den är tillgänglig!</span>
                            </li>
                        </ol>
                    </div>
