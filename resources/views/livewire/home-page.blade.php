                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center p-4 bg-accent-50 rounded-lg">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-900">Literary Excellence</div>
                                    <div class="text-sm text-gray-600">Award-winning storytelling</div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center p-4 bg-accent-50 rounded-lg">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-900">Emotional Journey</div>
                                    <div class="text-sm text-gray-600">Touch hearts and inspire minds</div>
                                </div>
                            </div>
                        </div>
