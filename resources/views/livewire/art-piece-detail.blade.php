        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl p-6 grid grid-cols-1 gap-4 shadow-md">
                        @if($artPiece->medium)
                        ...
                        @if($artPiece->price)
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <dd class="text-base text-gray-900 font-medium mt-1">{{ number_format($artPiece->price, 0) }} {{ $artPiece->currency }}</dd>
                                </div>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-8 shadow-md">
                        ...
                        <a href="{{ route('contact', ['art' => $artPiece->title]) }}" 
                           class="inline-block w-full text-center bg-primary-600 text-white px-6 py-4 rounded-full hover:bg-primary-700 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 font-medium text-lg">
                            Contact for Inquiry
                        </a>
                    </div>
