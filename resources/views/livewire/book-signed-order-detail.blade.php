        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-6">
                ...
                <div class="inline-block bg-[#F2D837] px-8 py-3 rounded-full">
                    <p class="text-lg md:text-xl font-bold text-brown-900 uppercase tracking-wide">Bestall med signering!</p>
                </div>
            </div>

            <div class="mt-8 text-center">
                <p class="text-2xl font-display font-bold mb-2 text-stone-900">
                    Signerad av forfattaren!
                </p>
                <p class="text-lg text-brown-700">Be om en personlig dedikation och fa boken hemskickad</p>
            </div>
        </div>
    </section>
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-xl mb-8 border-2 border-gray-200">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start bg-white p-4 rounded-2xl shadow-sm">
                                ...
                                <div class="flex-1">
                                    <div class="text-sm font-semibold text-brown-700 uppercase tracking-wide mb-1">Signerad av forfattaren</div>
                                    <div class="text-lg font-bold text-brown-900">Ingar!</div>
                                    <div class="text-sm text-gray-600">Be om en personlig halsning fran Linda</div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start bg-white p-4 rounded-2xl shadow-sm">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-lg font-bold text-brown-900">{{ $book->getEffectiveShippingCost() }} SEK</div>
                ...
                <div class="lg:sticky lg:top-8 h-fit">
                    <div class="bg-white p-8 rounded-3xl shadow-xl border-2 border-gray-200">
                        <div class="text-center mb-6">
                            ...
                            <p class="text-gray-600">Bestall din signerade bok</p>
                        </div>

                        <livewire:book-signed-order-form :book="$book" />
                    </div>
                    ...
                    <div class="mt-6 bg-gradient-to-br from-yellow-50 to-amber-50 p-6 rounded-2xl border-2 border-[#F2D837]">
                        ...
                        <ol class="space-y-2 text-sm text-brown-800">
                            <li class="flex items-start">
                                ...
                                <span>Fyll i formularet och skriv din onskade dedikation</span>
                            </li>
                            <li class="flex items-start">
                            ...
                            <li class="flex items-start">
                                ...
                                <span>Boken signeras och skickas hem till dig inom nagra dagar!</span>
                            </li>
                        </ol>
                    </div>
