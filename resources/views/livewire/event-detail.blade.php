        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-6">
                ...
                @if($event->hero_badge_text)
                    <div class="inline-block px-8 py-3 rounded-full" style="background-color: #F2D837;">
                ...
                <div>
                    <div class="bg-white p-8 rounded-3xl shadow-xl mb-8 border-2 border-gray-200">
                        <h2 class="text-3xl font-display font-bold text-brown-900 mb-6 flex items-center">
                            <svg class="w-8 h-8 mr-3" style="color: #F2D837;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start bg-white p-4 rounded-2xl shadow-sm">
                                <div class="flex-shrink-0 w-16 h-16 rounded-2xl flex items-center justify-center text-white mr-4" style="background-color: #F2D837;">
                            ...
                            <div class="flex items-start bg-white p-4 rounded-2xl shadow-sm">
                                ...
                                <div class="flex-1">
                                    ...
                                    @if($event->availableSpots() <= 10 && $event->availableSpots() > 0)
                                        <div class="text-sm font-semibold mt-1" style="color: #F2D837;">⚠️ Bara några platser kvar!</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-lg border-2 border-gray-200">
                        <h3 class="text-2xl font-display font-bold text-brown-900 mb-4 flex items-center">
                            <svg class="w-7 h-7 mr-3" style="color: #F2D837;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
