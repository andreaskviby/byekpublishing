        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center mb-6">
                ...
                @if($event->hero_badge_text)
                    <div class="inline-block bg-primary-400 px-8 py-3 rounded-full">
                    ...
                    <div class="bg-white p-8 rounded-3xl shadow-xl mb-8 border-2 border-gray-200">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start bg-white p-4 rounded-2xl shadow-sm">
                                <div class="flex-shrink-0 w-16 h-16 bg-primary-400 rounded-2xl flex items-center justify-center text-white mr-4">
                            ...
                            <div class="flex items-start bg-white p-4 rounded-2xl shadow-sm">
                                ...
                                <div class="flex-1">
                                    ...
                                    @if($event->availableSpots() <= 10 && $event->availableSpots() > 0)
                                        <div class="text-sm text-primary-600 font-semibold mt-1">⚠️ Bara några platser kvar!</div>
                                    @endif
                                </div>
                            </div>
                        </div>
