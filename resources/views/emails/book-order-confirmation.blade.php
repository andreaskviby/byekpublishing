...
<body>
    <div class="container">
        ...
        <p>Hej {{ $order->name }},</p>
        <p>Tack for din bestallning av "<strong>{{ $book->title }}</strong>"!</p>
        ...
        <div class="section">
            ...
            @if($order->wants_gift_wrap)
                <div class="info-row"><strong>Julklappsinpackning:</strong> +49 SEK</div>
            @endif
            <div class="info-row"><strong>Totalt:</strong> <span class="highlight">{{ $order->total_price }} SEK</span></div>
        </div>
        ...
        @if($order->wants_gift_wrap)
            <div class="section">
                ...
                <p>Du har valt att fa boken inpackad som julklapp (+49 SEK).</p>
            </div>
        @endif
