...
use App\Livewire\BookOrderDetail;
use App\Livewire\BookPreorderDetail;
use App\Livewire\BookSignedOrderDetail;
...
Route::get('/books/{book:slug}/preorder', BookPreorderDetail::class)->name('book.preorder');
Route::get('/books/{book:slug}/order', BookOrderDetail::class)->name('book.order');
Route::get('/books/{book:slug}/signed', BookSignedOrderDetail::class)->name('book.signed');
